...
// callers as the store's saved record, and seeding it with identity defaults would
...
export function normalizeSettings(raw) {
  ...
  return {
    ...
    // Instance identity sits at the *end* of each chain, never in the merge
    ...
    // latin name must keep it. Every value here
    // stays editable from Admin; clearing a field restores the safe fallback.
