 ...
 */
export const MANAGER = { email: "super@acceptance.invalid", password: "Validation!Pass42" };
export const EMPLOYEE = { email: "admin@acceptance.invalid", password: "Validation!Pass42" };
export const DISABLED = { email: "inactive@acceptance.invalid", password: "Validation!Pass42" };
