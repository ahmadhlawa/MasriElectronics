...
Installed as `masri-preview`; Masri Electronics intentionally ships no default preview dataset.
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    def with_dataset(name: str, help_text: str):
        ...
        sub_parser.add_argument(
            ...
            required=True,
            metavar="PATH",
            help="Preview dataset YAML path (required; Masri Electronics ships no default dataset).",
        )
        return sub_parser
