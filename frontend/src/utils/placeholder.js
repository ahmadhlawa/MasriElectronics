...
const TONES = {
  ...
  graphite: ["var(--brand-soft)", "var(--brand-primary-pale)"],
  ...
  accent: ["color-mix(in srgb,var(--brand-secondary) 16%,var(--surface-background))", "color-mix(in srgb,var(--brand-secondary) 58%,var(--surface-background))"],
