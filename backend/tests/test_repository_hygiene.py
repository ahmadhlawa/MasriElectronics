...
# `masri_preview.db.20260804-051436.bak`, so a rule anchored on `.db$` missed them.
...
def test_the_matcher_recognises_the_files_that_actually_leaked() -> None:
    ...
    """
    leaked = [
        "backend/data/masri_preview.20260802-192413.bak",
        "backend/data/masri_preview.db.20260804-051436.bak",
        "backend/data/masri_store_dev.20260802-192413.bak",
        "backend/data/masri_store_dev.db.20260804-051436.bak",
