...
demonstration. Masri Electronics ships none today — the fork deliberately left the template's
Masri Electronics demo catalogue behind — so that check is a standing guard rather than
...
# ── the file loader ──────────────────────────────────────────────────────────────────
# These used to run against the template's shipped Masri Electronics catalogue, which is the
...
def test_every_shipped_preview_dataset_is_valid_and_price_honest() -> None:
    """Shipping no dataset is a valid state, and is where Masri Electronics stands.
