...
def test_social_links_and_visibility_round_trip_without_leaking_private_settings(
    ...
    updated = client.patch(
        ...
        headers=auth(admin_token),
        json={
            "instagram_url": "https://instagram.com/masri",
            "instagram_visible": True,
            "facebook_url": "https://facebook.com/masri",
            "facebook_visible": False,
            "tiktok_url": None,
            "tiktok_visible": True,
            "youtube_url": "https://youtube.com/@masri",
    ...
    public = client.get("/api/v1/store/settings").json()
    assert public["instagram_url"] == "https://instagram.com/masri"
...
def test_masri_preview_placeholder_is_a_valid_distinct_png() -> None:
    data = masri_preview_png(80, 48, (91, 62, 133), (228, 179, 60), "gifts")
    assert data.startswith(b"\x89PNG\r\n\x1a\n")
